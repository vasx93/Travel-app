...
function updateBase(_x3) {
  return _updateBase.apply(this, arguments);
}

function _updateBase() {
  _updateBase = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(data) {
    var res;
...
function updatePw(_x4, _x5, _x6) {
  return _updatePw.apply(this, arguments);
}

function _updatePw() {
  _updatePw = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(password, newPassword, confirmPassword) {
    var res;
...
var checkoutBtn = document.getElementById('book-tour'); // //* LOGIN EVENTS
