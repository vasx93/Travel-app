...
},{}],"userAccount.js":[function(require,module,exports) {
"use strict";
...
exports.deleteTourBtn = deleteTourBtn;
...
function _signup() {
  _signup = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password) {
    var res;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.post('http://localhost:5555/api/users/login', {
              email: email,
              password: password
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return _axios.default.get('http://localhost:5555/api/users/logout');
...
function updateBase(_x6) {
  return _updateBase.apply(this, arguments);
}

function _updateBase() {
  _updateBase = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(data) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            if (res.status === 200) {
              (0, _alerts.showAlert)('success', 'Update successful!');
              location.assign('/me');
            }
...
function updatePw(_x7, _x8, _x9) {
  return _updatePw.apply(this, arguments);
} // admin delete


function _updatePw() {
  _updatePw = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(password, newPassword, confirmPassword) {
    var res;
...
function deleteTourBtn(_x10) {
  return _deleteTourBtn.apply(this, arguments);
}

function _deleteTourBtn() {
  _deleteTourBtn = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(id) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://localhost:5555/api/tours/".concat(id)
            });
          ...
          case 3:
            ...
            if (res.status === 204) {
              (0, _alerts.showAlert)('success', 'Delete successful!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
var stripe = Stripe("pk_test_51IJqyvJwQBNX4onRqymShqFiqKexwWUZ8Uof7hj6FweEYRnIsoPhENSQJtrMzmMI481Npgffzp25jiH5pPLiP8MB00qgA2WSJN");
...
var loginForm = document.querySelector('#samoodbrana');
var logoutBtn = document.querySelector('.nav__el--logout');
var updateAccount = document.querySelector('.form-user-data');
var updatePwForm = document.querySelector('.form-user-settings');
var checkoutBtn = document.getElementById('book-tour');
var deleteTour = document.getElementById('delete-tour'); //* LOGIN EVENTS
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    (0, _userAccount.signup)(name, email, password);
  });
}
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var password = document.getElementById('password').value;
    (0, _userAccount.login)(email, password);
  });
}

if (logoutBtn) {
  logoutBtn.addEventListener('click', _userAccount.logout);
} //* USER ACCOUNT EVENTS
...
if (updateAccount) {
  updateAccount.addEventListener('submit', function (e) {
    ...
    (0, _userAccount.updateBase)(form);
  });
}
...
if (updatePwForm) {
  updatePwForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var pw = document.getElementById('password-current').value;
    var newPw = document.getElementById('password').value;
    var cPw = document.getElementById('password-confirm').value;
    (0, _userAccount.updatePw)(pw, newPw, cPw);
  });
} //* BOOKING
...
if (checkoutBtn) {
  checkoutBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...'; // data from DOM element
